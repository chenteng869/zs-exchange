...
with sync_playwright() as p:
    ...
    page.wait_for_timeout(5000)  # 等编译
    out1 = os.path.join(OUT_DIR, "home-v5-hero.png")
    ...
    out2 = os.path.join(OUT_DIR, "home-v5-features.png")
    ...
    page.wait_for_timeout(2000)
    out3 = os.path.join(OUT_DIR, "home-v5-bottom.png")
    page.screenshot(path=out3, full_page=False)
    print(f"OK bottom -> {out3}")

    # 完整长截图
    out4 = os.path.join(OUT_DIR, "home-v5-full.png")
    page.screenshot(path=out4, full_page=True)
    print(f"OK full -> {out4}")
