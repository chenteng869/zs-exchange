// gen-developer-step2-data.js
// 生成 tpl-developer-data.txt（mock 数据）
const fs = require('fs');
const path = require('path');

const out = path.join(__dirname, 'tpl-developer-data.txt');

const data = `// Mock 数据 - 全部使用模拟数据，不连接真实 API
...
console.log('OK data - ' + data.length + ' bytes');
