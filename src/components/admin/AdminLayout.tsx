...
const menuItems = [
  ...
  // ====== 福建老酒 ======
  {
    ...
    children: [
      {
        key: '/admin/fujian/products',
        icon: <AppstoreOutlined />,
        label: '商品管理',
      },
      {
        key: '/admin/fujian/orders',
        icon: <ShoppingCartOutlined />,
        label: '订单管理',
      },
      {
        key: '/admin/fujian/channel',
        icon: <TeamOutlined />,
        label: '渠道中心',
      },
      {
        key: '/admin/fujian/profits',
        icon: <DollarOutlined />,
        label: '分润管理',
      },
      {
        key: '/admin/fujian/members',
        icon: <UsergroupAddOutlined />,
        label: '会员管理',
      },
    ],
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {collapsed ? (
            <div style={{ color: '#FFFFFF', fontSize: 20, fontWeight: 700 }}>ZS</div>
          ) : (
            <div style={{ color: '#FFFFFF', fontSize: 18, fontWeight: 700 }}>中萨数字科技交易所</div>
          )}
        </div>
        <Menu
          theme="dark"
