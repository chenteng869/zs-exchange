...
/**
 * /admin/fujian/notification - 369 福建老酒业务 / notification（2026-07-11 工业级重写）
 *
...
export default function NotificationPage() {
  ...
  return (
    <AdminLayout title="369 福建老酒业务 / notification">
        ...
        <Row gutter={16} align="middle">
          <Col flex="auto">
            <Space size={12} align="center">
              ...
              <div>
                <h2 style={{ margin: 0, color: '#fff', fontSize: 22, fontWeight: 700 }}>369 福建老酒业务 / notification</h2>
        ...
        <Row gutter={16}>
          <Col xs={24} md={16}>
            <div style={{ padding: 12, background: '#0F172A', borderRadius: 8, fontFamily: 'monospace', fontSize: 11, color: '#94A3B8', maxHeight: 200, overflowY: 'auto', lineHeight: 1.7 }}>
              <div><span style={{ color: '#10B981' }}>[14:32:15]</span> <span style={{ color: '#60A5FA' }}>INFO</span>  system.event: page_view path=/admin/notification user=admin</div>
              ...
              <div><span style={{ color: '#10B981' }}>[14:32:33]</span> <span style={{ color: '#60A5FA' }}>INFO</span>  audit.log: page_view notification user=admin</div>
