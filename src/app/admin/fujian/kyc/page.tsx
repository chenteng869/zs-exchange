...
/**
 * /admin/fujian/kyc - 369 福建老酒业务 / kyc（2026-07-11 工业级重写）
 *
...
export default function KycPage() {
  ...
  return (
    <AdminLayout title="369 福建老酒业务 / kyc">
        ...
        <Row gutter={16} align="middle">
          <Col flex="auto">
            <Space size={12} align="center">
              ...
              <div>
                <h2 style={{ margin: 0, color: '#fff', fontSize: 22, fontWeight: 700 }}>369 福建老酒业务 / kyc</h2>
