...
/**
 * /admin/quant/dashboard - 量化交易 / dashboard（2026-07-11 工业级重写）
 *
...
export default function DashboardPage() {
  ...
  return (
    <AdminLayout title="量化交易 / dashboard">
        ...
        <Row gutter={16} align="middle">
          <Col flex="auto">
            <Space size={12} align="center">
              ...
              <div>
                <h2 style={{ margin: 0, color: '#fff', fontSize: 22, fontWeight: 700 }}>量化交易 / dashboard</h2>
