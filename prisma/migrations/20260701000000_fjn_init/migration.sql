-- DropForeignKey
ALTER TABLE "core_user_dids" DROP CONSTRAINT "core_user_dids_userId_fkey";

-- CreateTable
CREATE TABLE "DefiFeeRevenuePool" (
    "id" UUID NOT NULL DEFAULT uuid_generate_v4(),
    "periodStart" TIMESTAMPTZ NOT NULL,
    "periodEnd" TIMESTAMPTZ NOT NULL,
    "currency" VARCHAR(20) NOT NULL,
    "totalFeeRevenue" DECIMAL(36,18) NOT NULL DEFAULT 0,
    "shareRatio" DECIMAL(5,4) NOT NULL DEFAULT 0,
    "poolAmount" DECIMAL(36,18) NOT NULL DEFAULT 0,
    "totalWeight" DECIMAL(36,18) NOT NULL DEFAULT 0,
    "distributedAmount" DECIMAL(36,18) NOT NULL DEFAULT 0,
    "status" VARCHAR(20) NOT NULL DEFAULT 'pending',
    "createdAt" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "distributedAt" TIMESTAMPTZ,

    CONSTRAINT "DefiFeeRevenuePool_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "DefiStakingRewardDistribution" (
    "id" UUID NOT NULL DEFAULT uuid_generate_v4(),
    "revenuePoolId" UUID NOT NULL,
    "stakingId" UUID NOT NULL,
    ...
    CONSTRAINT "DefiStakingRewardDistribution_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "PointsAccount" (
    ...
    "lifetimeEarned" DECIMAL(20,4) NOT NULL DEFAULT 0,
    "lifetimeSpent" DECIMAL(20,4) NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE INDEX "DefiFeeRevenuePool_periodStart_periodEnd_idx" ON "DefiFeeRevenuePool"("periodStart", "periodEnd");

-- CreateIndex
CREATE INDEX "DefiStakingRewardDistribution_userId_idx" ON "DefiStakingRewardDistribution"("userId");

-- CreateIndex
CREATE INDEX "DefiStakingRewardDistribution_stakingId_idx" ON "DefiStakingRewardDistribution"("stakingId");
...
-- CreateIndex
CREATE INDEX "PointsLedger_bizType_bizNo_idx" ON "PointsLedger"("bizType", "bizNo");
...
-- AddForeignKey
ALTER TABLE "core_user_dids" ADD CONSTRAINT "core_user_dids_userId_fkey" FOREIGN KEY ("userId") REFERENCES "CoreUser"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DefiStakingRewardDistribution" ADD CONSTRAINT "DefiStakingRewardDistribution_revenuePoolId_fkey" FOREIGN KEY ("revenuePoolId") REFERENCES "DefiFeeRevenuePool"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DefiStakingRewardDistribution" ADD CONSTRAINT "DefiStakingRewardDistribution_stakingId_fkey" FOREIGN KEY ("stakingId") REFERENCES "DefiStaking"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
